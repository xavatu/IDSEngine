...
eve_path = "json/malicious_logs.json"
csv_out = "csv/malicious_logs.csv"
vulns_path = "csv/vulns.csv"
...
df["x-zap-scan-id"] = df["payload_printable"].apply(extract_zap_scan_id)
